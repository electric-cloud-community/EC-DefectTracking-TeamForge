    ...
    extends ComponentBase
{
    ...
    @Override public Widget doInit()
    {
        ...
        Widget htmlH1 = new HTML("<h1>TeamForge Defects</h1>");

        vPanel.add(htmlH1);

        // Label label = new Label("TeamForge defects associated with the
        // ElectricCommander job:");
        Widget htmlLabel = new HTML(
                "<p><b>TeamForge defects associated with the ElectricCommander job:</b></p>");
        ...
        vPanel.add(new HTML(
                "<p><b>TeamForge updated defects associated with the ElectricCommander job:</b></p>"));
        ...
        vPanel.add(new HTML(
                "<p><b>TeamForge created defects associated with the ElectricCommander job:</b></p>"));
            ...
            final FormTable      formTable)
    {
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "TeamForge Reports doInit: setting up getProperties command request");
        }
        ...
        if (getLog().isDebugEnabled()) {
            getLog().debug(
                "TeamForge Reports doInit: Issuing Commander request: "
        ...
        fileDefectButton.addClickHandler(new ClickHandler() {
                ...
                public void onClick(ClickEvent event)
                {
                    ...
                    request.setProjectName(
                            "/plugins/EC-DefectTracking-TeamForge/project")
